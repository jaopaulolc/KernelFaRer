...
define void @_Z14staticSizeGEMMPA16_KdPA64_S_PA8_ddd(ptr %A, ptr %B, ptr %C, double %alpha, double %beta) {
...
; CHECK-NEXT:    [[TMP4:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(ptr align 8 [[C:%.*]], i64 8, i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP8]], ptr align 8 [[C]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x double], ptr %A, i64 %indvars.iv, i64 %indvars.iv58
