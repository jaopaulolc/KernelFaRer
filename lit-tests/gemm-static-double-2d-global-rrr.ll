...
; CHECK-NEXT:    [[TMP6:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(ptr align 8 @C, i64 8, i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP10]], ptr align 8 @C, i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %arrayidx19 = getelementptr inbounds [16 x [8 x double]], ptr @C, i64 0, i64 %indvars.iv57, i64 %indvars.iv54
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x [64 x double]], ptr @A, i64 0, i64 %indvars.iv57, i64 %indvars.iv
