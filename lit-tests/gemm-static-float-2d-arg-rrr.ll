...
define void @_Z14staticSizeGEMMPA64_KfPA8_S_PA8_fff(ptr %A, ptr %B, ptr %C, float %alpha, float %beta) {
...
; CHECK-NEXT:    [[TMP6:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(ptr align 4 [[C:%.*]], i64 8, i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP10]], ptr align 4 [[C]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [64 x float], ptr %A, i64 %indvars.iv58, i64 %indvars.iv
  %1 = load float, ptr %arrayidx10, align 4
  %arrayidx14 = getelementptr inbounds [8 x float], ptr %B, i64 %indvars.iv, i64 %indvars.iv55
