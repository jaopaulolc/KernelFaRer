...
define void @_Z11fixedSizeMMPA16_KdPA64_S_PA8_d(ptr %A, ptr %B, ptr %C) {
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP3]], ptr align 8 [[C:%.*]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
