...
define void @_Z11fixedSizeMMPA64_KdS1_PA16_d(ptr %A, ptr %B, ptr %C) {
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx18 = getelementptr inbounds [16 x double], ptr %C, i64 %indvars.iv45, i64 %indvars.iv48
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [64 x double], ptr %A, i64 %indvars.iv48, i64 %indvars.iv
  %0 = load double, ptr %arrayidx10, align 8
  %arrayidx14 = getelementptr inbounds [64 x double], ptr %B, i64 %indvars.iv45, i64 %indvars.iv
