...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP3]], ptr align 8 @C, i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx18 = getelementptr inbounds [8 x [16 x double]], ptr @C, i64 0, i64 %indvars.iv45, i64 %indvars.iv48
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x [64 x double]], ptr @A, i64 0, i64 %indvars.iv48, i64 %indvars.iv
  %0 = load double, ptr %arrayidx10, align 8
  %arrayidx14 = getelementptr inbounds [8 x [64 x double]], ptr @B, i64 0, i64 %indvars.iv45, i64 %indvars.iv
