...
define void @_Z11fixedSizeMMPA16_KfPA64_S_PA16_f(ptr %A, ptr %B, ptr %C) {
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP2]], ptr align 4 [[C:%.*]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx18 = getelementptr inbounds [16 x float], ptr %C, i64 %indvars.iv45, i64 %indvars.iv48
