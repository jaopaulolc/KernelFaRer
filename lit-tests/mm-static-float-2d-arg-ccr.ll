...
define void @_Z11fixedSizeMMPA16_KfPA64_S_PA8_f(ptr %A, ptr %B, ptr %C) {
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP3]], ptr align 4 [[C:%.*]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx18 = getelementptr inbounds [8 x float], ptr %C, i64 %indvars.iv48, i64 %indvars.iv45
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x float], ptr %A, i64 %indvars.iv, i64 %indvars.iv48
  %0 = load float, ptr %arrayidx10, align 4
  %arrayidx14 = getelementptr inbounds [64 x float], ptr %B, i64 %indvars.iv45, i64 %indvars.iv
