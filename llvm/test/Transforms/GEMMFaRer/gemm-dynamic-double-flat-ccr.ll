...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @cblas_dgemm(i32 101, i32 112, i32 112, i32 [[M:%.*]], i32 [[N:%.*]], i32 [[K:%.*]], double [[ALPHA:%.*]], double* [[A:%.*]], i32 [[LDA:%.*]], double* [[B:%.*]], i32 [[LDB:%.*]], double [[BETA:%.*]], double* [[C:%.*]], i32 [[LDC:%.*]])
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.body8
  ...
  %c.053 = phi double [ 0.000000e+00, %for.body8.lr.ph ], [ %add14, %for.body8 ]
  %7 = mul nsw i64 %indvars.iv, %0
  %8 = add nsw i64 %7, %indvars.iv70
