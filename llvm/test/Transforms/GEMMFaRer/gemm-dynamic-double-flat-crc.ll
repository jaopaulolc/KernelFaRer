...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @cblas_dgemm(i32 102, i32 111, i32 112, i32 [[M:%.*]], i32 [[N:%.*]], i32 [[K:%.*]], double [[ALPHA:%.*]], double* [[A:%.*]], i32 [[LDA:%.*]], double* [[B:%.*]], i32 [[LDB:%.*]], double [[BETA:%.*]], double* [[C:%.*]], i32 [[LDC:%.*]])
; CHECK-NEXT:    ret void
;
entry:
