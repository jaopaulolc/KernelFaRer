...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @cblas_dgemm(i32 102, i32 112, i32 111, i32 [[M:%.*]], i32 [[N:%.*]], i32 [[K:%.*]], double [[ALPHA:%.*]], double* [[A:%.*]], i32 [[LDA:%.*]], double* [[B:%.*]], i32 [[LDB:%.*]], double [[BETA:%.*]], double* [[C:%.*]], i32 [[LDC:%.*]])
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8, %for.cond5.preheader
  ...
  %5 = mul nsw i64 %indvars.iv63, %1
  %6 = add nsw i64 %5, %indvars.iv70
  %arrayidx19 = getelementptr inbounds double, double* %C, i64 %6
  ...
  %exitcond69.not = icmp eq i64 %indvars.iv.next64, %wide.trip.count68
