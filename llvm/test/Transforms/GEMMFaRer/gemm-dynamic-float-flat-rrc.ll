...
define void @_Z14dynamicSizeGEMMiiiPKfiS0_iPfiff(i32 %m, i32 %n, i32 %k, float* %A, i32 %lda, float* %B, i32 %ldb, float* %C, i32 %ldc, float %alpha, float %beta) {
; CHECK-LABEL: @_Z14dynamicSizeGEMMiiiPKfiS0_iPfiff(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @cblas_sgemm(i32 102, i32 112, i32 112, i32 [[M:%.*]], i32 [[N:%.*]], i32 [[K:%.*]], float [[ALPHA:%.*]], float* [[A:%.*]], i32 [[LDA:%.*]], float* [[B:%.*]], i32 [[LDB:%.*]], float [[BETA:%.*]], float* [[C:%.*]], i32 [[LDC:%.*]])
; CHECK-NEXT:    ret void
;
entry:
