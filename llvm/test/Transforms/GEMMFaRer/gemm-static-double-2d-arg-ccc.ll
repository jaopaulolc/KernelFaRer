...
define void @_Z14staticSizeGEMMPA16_KdPA64_S_PA16_ddd([16 x double]* %A, [64 x double]* %B, [16 x double]* %C, double %alpha, double %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA16_KdPA64_S_PA16_ddd(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    [[TMP9:%.*]] = fadd <128 x double> [[TMP6]], [[TMP8]]
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP9]], double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
