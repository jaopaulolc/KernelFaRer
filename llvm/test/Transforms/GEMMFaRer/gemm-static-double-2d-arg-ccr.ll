...
define void @_Z14staticSizeGEMMPA16_KdPA64_S_PA8_ddd([16 x double]* %A, [64 x double]* %B, [8 x double]* %C, double %alpha, double %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA16_KdPA64_S_PA8_ddd(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast [16 x double]* [[A:%.*]] to double*
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast [64 x double]* [[B:%.*]] to double*
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast [8 x double]* [[C:%.*]] to double*
; CHECK-NEXT:    [[TMP3:%.*]] = call <1024 x double> @llvm.matrix.column.major.load.v1024f64.i64(double* align 8 [[TMP0]], i64 16, i1 false, i32 16, i32 64)
; CHECK-NEXT:    [[TMP4:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64.i64(double* align 8 [[TMP1]], i64 64, i1 false, i32 64, i32 8)
...
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP11]], double* align 8 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %arrayidx19 = getelementptr inbounds [8 x double], [8 x double]* %C, i64 %indvars.iv58, i64 %indvars.iv55
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x double], [16 x double]* %A, i64 %indvars.iv, i64 %indvars.iv58
