...
define void @_Z14staticSizeGEMMPA16_KdPA8_S_PA16_ddd([16 x double]* %A, [8 x double]* %B, [16 x double]* %C, double %alpha, double %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA16_KdPA8_S_PA16_ddd(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[TMP8:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP10]], double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
