...
; CHECK-NEXT:    [[TMP9:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64(double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64(<128 x double> [[TMP11]], double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
