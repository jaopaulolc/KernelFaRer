...
define void @_Z14staticSizeGEMMPA64_KdPA8_S_PA8_ddd([64 x double]* %A, [8 x double]* %B, [8 x double]* %C, double %alpha, double %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA64_KdPA8_S_PA8_ddd(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast [64 x double]* [[A:%.*]] to double*
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast [8 x double]* [[B:%.*]] to double*
...
; CHECK-NEXT:    [[TMP5:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64.i64(double* align 8 [[TMP1]], i64 8, i1 false, i32 8, i32 64)
...
; CHECK-NEXT:    [[TMP8:%.*]] = fmul <128 x double> [[SCALAR_SPLAT_SPLAT]], [[TMP7]]
; CHECK-NEXT:    [[TMP9:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP10:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP9]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP11:%.*]] = fmul <128 x double> [[SCALAR_SPLAT_SPLAT2]], [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = fadd <128 x double> [[TMP8]], [[TMP11]]
; CHECK-NEXT:    [[TMP13:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP12]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP13]], double* align 8 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx14 = getelementptr inbounds [8 x double], [8 x double]* %B, i64 %indvars.iv, i64 %indvars.iv55
