...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call <1024 x double> @llvm.matrix.column.major.load.v1024f64(double* align 8 getelementptr inbounds ([64 x [16 x double]], [64 x [16 x double]]* @A, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 64)
; CHECK-NEXT:    [[TMP1:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64(double* align 8 getelementptr inbounds ([8 x [64 x double]], [8 x [64 x double]]* @B, i32 0, i32 0, i32 0), i64 64, i1 false, i32 64, i32 8)
...
; CHECK-NEXT:    [[TMP4:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64(double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP5:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP4]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP7:%.*]] = fadd <128 x double> [[TMP3]], [[TMP6]]
; CHECK-NEXT:    [[TMP8:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP7]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64(<128 x double> [[TMP8]], double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
