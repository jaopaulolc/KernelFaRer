...
; CHECK-NEXT:    [[TMP1:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64(double* align 8 getelementptr inbounds ([64 x [8 x double]], [64 x [8 x double]]* @B, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 64)
