...
; CHECK-NEXT:    [[TMP5:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 getelementptr inbounds ([8 x [16 x double]], [8 x [16 x double]]* @C, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP7]], double* align 8 getelementptr inbounds ([8 x [16 x double]], [8 x [16 x double]]* @C, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
