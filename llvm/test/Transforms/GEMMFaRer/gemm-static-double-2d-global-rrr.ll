...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call <1024 x double> @llvm.matrix.column.major.load.v1024f64(double* align 8 getelementptr inbounds ([16 x [64 x double]], [16 x [64 x double]]* @A, i32 0, i32 0, i32 0), i64 64, i1 false, i32 64, i32 16)
; CHECK-NEXT:    [[TMP1:%.*]] = call <1024 x double> @llvm.matrix.transpose.v1024f64(<1024 x double> [[TMP0]], i32 64, i32 16)
; CHECK-NEXT:    [[TMP2:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64(double* align 8 getelementptr inbounds ([64 x [8 x double]], [64 x [8 x double]]* @B, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 64)
...
; CHECK-NEXT:    [[TMP6:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64(double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64(<128 x double> [[TMP10]], double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
