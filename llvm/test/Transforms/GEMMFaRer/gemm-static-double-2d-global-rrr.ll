...
@A = global [16 x [64 x double]] zeroinitializer, align 16
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call <1024 x double> @llvm.matrix.column.major.load.v1024f64.i64(double* align 8 getelementptr inbounds ([16 x [64 x double]], [16 x [64 x double]]* @A, i32 0, i32 0, i32 0), i64 64, i1 false, i32 64, i32 16)
; CHECK-NEXT:    [[TMP1:%.*]] = call <1024 x double> @llvm.matrix.transpose.v1024f64(<1024 x double> [[TMP0]], i32 64, i32 16)
; CHECK-NEXT:    [[TMP2:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64.i64(double* align 8 getelementptr inbounds ([64 x [8 x double]], [64 x [8 x double]]* @B, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 64)
...
; CHECK-NEXT:    [[TMP6:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP6]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP8:%.*]] = fmul <128 x double> [[SCALAR_SPLAT_SPLAT2]], [[TMP7]]
; CHECK-NEXT:    [[TMP9:%.*]] = fadd <128 x double> [[TMP5]], [[TMP8]]
; CHECK-NEXT:    [[TMP10:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP9]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP10]], double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %arrayidx19 = getelementptr inbounds [16 x [8 x double]], [16 x [8 x double]]* @C, i64 0, i64 %indvars.iv57, i64 %indvars.iv54
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x [64 x double]], [16 x [64 x double]]* @A, i64 0, i64 %indvars.iv57, i64 %indvars.iv
  %1 = load double, double* %arrayidx10, align 8
  %arrayidx14 = getelementptr inbounds [64 x [8 x double]], [64 x [8 x double]]* @B, i64 0, i64 %indvars.iv, i64 %indvars.iv54
