...
define void @_Z14staticSizeGEMMPKdiS0_iPdidd(double* %A, i32 %lda, double* %B, i32 %ldb, double* %C, i32 %ldc, double %alpha, double %beta) {
...
; CHECK-NEXT:    [[TMP3:%.*]] = call <1024 x double> @llvm.matrix.column.major.load.v1024f64.i64(double* align 8 [[A:%.*]], i64 [[TMP0]], i1 false, i32 16, i32 64)
; CHECK-NEXT:    [[TMP4:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64.i64(double* align 8 [[B:%.*]], i64 [[TMP1]], i1 false, i32 64, i32 8)
...
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x double> @llvm.matrix.column.major.load.v128f64.i64(double* align 8 [[C:%.*]], i64 [[TMP2]], i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP11]], double* align 8 [[C]], i64 [[TMP2]], i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx = getelementptr inbounds double, double* %A, i64 %8
