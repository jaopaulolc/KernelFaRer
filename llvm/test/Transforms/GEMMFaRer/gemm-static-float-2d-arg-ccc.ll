...
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32(float* align 4 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32(<128 x float> [[TMP9]], float* align 4 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
