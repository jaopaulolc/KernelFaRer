...
define void @_Z14staticSizeGEMMPA16_KfPA64_S_PA16_fff([16 x float]* %A, [64 x float]* %B, [16 x float]* %C, float %alpha, float %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA16_KfPA64_S_PA16_fff(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(float* align 4 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP9]], float* align 4 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
