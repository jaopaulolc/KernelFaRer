...
define void @_Z14staticSizeGEMMPA16_KfPA64_S_PA16_fff(ptr %A, ptr %B, ptr %C, float %alpha, float %beta) {
...
; CHECK-NEXT:    [[TMP4:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(ptr align 4 [[C:%.*]], i64 16, i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP6]], ptr align 4 [[C]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %arrayidx19 = getelementptr inbounds [16 x float], ptr %C, i64 %indvars.iv55, i64 %indvars.iv58
