...
define void @_Z14staticSizeGEMMPA16_KfPA64_S_PA8_fff([16 x float]* %A, [64 x float]* %B, [8 x float]* %C, float %alpha, float %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA16_KfPA64_S_PA8_fff(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[TMP4:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32.i64(float* align 4 [[TMP1]], i64 64, i1 false, i32 64, i32 8)
...
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP8:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP7]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP10:%.*]] = fadd <128 x float> [[TMP6]], [[TMP9]]
; CHECK-NEXT:    [[TMP11:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP10]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP11]], float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
