...
define void @_Z14staticSizeGEMMPA64_KfS1_PA16_fff([64 x float]* %A, [64 x float]* %B, [16 x float]* %C, float %alpha, float %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA64_KfS1_PA16_fff(
; CHECK-NEXT:  entry:
