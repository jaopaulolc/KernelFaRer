...
; CHECK-NEXT:    [[TMP3:%.*]] = call <1024 x float> @llvm.matrix.column.major.load.v1024f32(float* align 4 [[TMP0]], i64 64, i1 false, i32 64, i32 16)
; CHECK-NEXT:    [[TMP4:%.*]] = call <1024 x float> @llvm.matrix.transpose.v1024f32(<1024 x float> [[TMP3]], i32 64, i32 16)
; CHECK-NEXT:    [[TMP5:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32(float* align 4 [[TMP1]], i64 8, i1 false, i32 8, i32 64)
...
; CHECK-NEXT:    [[TMP9:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32(float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32(<128 x float> [[TMP13]], float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
