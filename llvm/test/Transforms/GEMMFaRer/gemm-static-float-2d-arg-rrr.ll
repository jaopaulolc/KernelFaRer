...
define void @_Z14staticSizeGEMMPA64_KfPA8_S_PA8_fff([64 x float]* %A, [8 x float]* %B, [8 x float]* %C, float %alpha, float %beta) {
; CHECK-LABEL: @_Z14staticSizeGEMMPA64_KfPA8_S_PA8_fff(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[TMP9:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP10:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP9]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP11:%.*]] = fmul <128 x float> [[SCALAR_SPLAT_SPLAT2]], [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = fadd <128 x float> [[TMP8]], [[TMP11]]
; CHECK-NEXT:    [[TMP13:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP12]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP13]], float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
