...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call <1024 x float> @llvm.matrix.column.major.load.v1024f32.i64(float* align 4 getelementptr inbounds ([64 x [16 x float]], [64 x [16 x float]]* @A, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 64)
; CHECK-NEXT:    [[TMP1:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32.i64(float* align 4 getelementptr inbounds ([8 x [64 x float]], [8 x [64 x float]]* @B, i32 0, i32 0, i32 0), i64 64, i1 false, i32 64, i32 8)
; CHECK-NEXT:    [[TMP2:%.*]] = call <128 x float> @llvm.matrix.multiply.v128f32.v1024f32.v512f32(<1024 x float> [[TMP0]], <512 x float> [[TMP1]], i32 16, i32 64, i32 8)
...
; CHECK-NEXT:    [[TMP3:%.*]] = fmul <128 x float> [[SCALAR_SPLAT_SPLAT]], [[TMP2]]
; CHECK-NEXT:    [[TMP4:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(float* align 4 getelementptr inbounds ([16 x [8 x float]], [16 x [8 x float]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP5:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP4]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP7:%.*]] = fadd <128 x float> [[TMP3]], [[TMP6]]
; CHECK-NEXT:    [[TMP8:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP7]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP8]], float* align 4 getelementptr inbounds ([16 x [8 x float]], [16 x [8 x float]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %arrayidx19 = getelementptr inbounds [16 x [8 x float]], [16 x [8 x float]]* @C, i64 0, i64 %indvars.iv57, i64 %indvars.iv54
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [64 x [16 x float]], [64 x [16 x float]]* @A, i64 0, i64 %indvars.iv, i64 %indvars.iv57
  %1 = load float, float* %arrayidx10, align 4
  %arrayidx14 = getelementptr inbounds [8 x [64 x float]], [8 x [64 x float]]* @B, i64 0, i64 %indvars.iv54, i64 %indvars.iv
