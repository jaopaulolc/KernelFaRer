...
; CHECK-NEXT:    [[TMP1:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32(float* align 4 getelementptr inbounds ([64 x [8 x float]], [64 x [8 x float]]* @B, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 64)
