...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call <1024 x float> @llvm.matrix.column.major.load.v1024f32(float* align 4 getelementptr inbounds ([16 x [64 x float]], [16 x [64 x float]]* @A, i32 0, i32 0, i32 0), i64 64, i1 false, i32 64, i32 16)
; CHECK-NEXT:    [[TMP1:%.*]] = call <1024 x float> @llvm.matrix.transpose.v1024f32(<1024 x float> [[TMP0]], i32 64, i32 16)
; CHECK-NEXT:    [[TMP2:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32(float* align 4 getelementptr inbounds ([64 x [8 x float]], [64 x [8 x float]]* @B, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 64)
...
; CHECK-NEXT:    [[TMP5:%.*]] = fmul <128 x float> [[SCALAR_SPLAT_SPLAT]], [[TMP4]]
; CHECK-NEXT:    [[TMP6:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32(float* align 4 getelementptr inbounds ([16 x [8 x float]], [16 x [8 x float]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    [[TMP7:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP6]], i32 8, i32 16)
...
; CHECK-NEXT:    [[TMP9:%.*]] = fadd <128 x float> [[TMP5]], [[TMP8]]
; CHECK-NEXT:    [[TMP10:%.*]] = call <128 x float> @llvm.matrix.transpose.v128f32(<128 x float> [[TMP9]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32(<128 x float> [[TMP10]], float* align 4 getelementptr inbounds ([16 x [8 x float]], [16 x [8 x float]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [16 x [64 x float]], [16 x [64 x float]]* @A, i64 0, i64 %indvars.iv57, i64 %indvars.iv
  %1 = load float, float* %arrayidx10, align 4
  %arrayidx14 = getelementptr inbounds [64 x [8 x float]], [64 x [8 x float]]* @B, i64 0, i64 %indvars.iv, i64 %indvars.iv54
