...
; CHECK-NEXT:    [[TMP8:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(float* align 4 [[C:%.*]], i64 [[TMP2]], i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP10]], float* align 4 [[C]], i64 [[TMP2]], i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %3 = mul nsw i64 %indvars.iv63, %2
  %4 = add nsw i64 %3, %indvars.iv68
  ...
  %exitcond67.not = icmp eq i64 %indvars.iv.next64, 8
