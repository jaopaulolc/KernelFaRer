...
; CHECK-NEXT:    [[TMP5:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32.i64(float* align 4 [[B:%.*]], i64 [[TMP1]], i1 false, i32 64, i32 8)
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %5 = mul nsw i64 %indvars.iv61, %1
  %6 = add nsw i64 %5, %indvars.iv67
  %arrayidx19 = getelementptr inbounds float, float* %C, i64 %6
  ...
  %exitcond66.not = icmp eq i64 %indvars.iv.next62, 8
