...
; CHECK-NEXT:    [[TMP3:%.*]] = call <1024 x float> @llvm.matrix.column.major.load.v1024f32.i64(float* align 4 [[A:%.*]], i64 [[TMP0]], i1 false, i32 64, i32 16)
; CHECK-NEXT:    [[TMP4:%.*]] = call <1024 x float> @llvm.matrix.transpose.v1024f32(<1024 x float> [[TMP3]], i32 64, i32 16)
; CHECK-NEXT:    [[TMP5:%.*]] = call <512 x float> @llvm.matrix.column.major.load.v512f32.i64(float* align 4 [[B:%.*]], i64 [[TMP1]], i1 false, i32 8, i32 64)
...
; CHECK-NEXT:    [[TMP9:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32.i64(float* align 4 [[C:%.*]], i64 [[TMP2]], i1 false, i32 16, i32 8)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP11]], float* align 4 [[C]], i64 [[TMP2]], i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
