...
; CHECK-NEXT:    [[TMP9:%.*]] = call <128 x float> @llvm.matrix.column.major.load.v128f32(float* align 4 [[C:%.*]], i64 [[TMP2]], i1 false, i32 8, i32 16)
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32(<128 x float> [[TMP13]], float* align 4 [[C]], i64 [[TMP2]], i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
