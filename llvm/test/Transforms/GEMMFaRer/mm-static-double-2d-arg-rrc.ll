...
define void @_Z11fixedSizeMMPA64_KdPA8_S_PA16_d([64 x double]* %A, [8 x double]* %B, [16 x double]* %C) {
; CHECK-LABEL: @_Z11fixedSizeMMPA64_KdPA8_S_PA16_d(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP7]], double* align 8 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
