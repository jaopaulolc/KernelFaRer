...
define void @_Z11fixedSizeMMPA64_KdPA8_S_PA8_d([64 x double]* %A, [8 x double]* %B, [8 x double]* %C) {
; CHECK-LABEL: @_Z11fixedSizeMMPA64_KdPA8_S_PA8_d(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP8]], double* align 8 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
