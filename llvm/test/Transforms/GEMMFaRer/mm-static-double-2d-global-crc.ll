...
; CHECK-NEXT:    [[TMP1:%.*]] = call <512 x double> @llvm.matrix.column.major.load.v512f64.i64(double* align 8 getelementptr inbounds ([64 x [8 x double]], [64 x [8 x double]]* @B, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 64)
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [64 x [16 x double]], [64 x [16 x double]]* @A, i64 0, i64 %indvars.iv, i64 %indvars.iv48
