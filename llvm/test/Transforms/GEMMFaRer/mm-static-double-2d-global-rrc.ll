...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP4]], double* align 8 getelementptr inbounds ([8 x [16 x double]], [8 x [16 x double]]* @C, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
