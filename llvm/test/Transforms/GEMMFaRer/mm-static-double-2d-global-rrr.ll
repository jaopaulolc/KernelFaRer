...
; CHECK-NEXT:    [[TMP5:%.*]] = call <128 x double> @llvm.matrix.transpose.v128f64(<128 x double> [[TMP4]], i32 16, i32 8)
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP5]], double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx18 = getelementptr inbounds [16 x [8 x double]], [16 x [8 x double]]* @C, i64 0, i64 %indvars.iv48, i64 %indvars.iv45
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx14 = getelementptr inbounds [64 x [8 x double]], [64 x [8 x double]]* @B, i64 0, i64 %indvars.iv, i64 %indvars.iv45
