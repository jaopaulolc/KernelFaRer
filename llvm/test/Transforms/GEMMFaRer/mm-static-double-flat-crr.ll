...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP7]], double* align 8 [[C:%.*]], i64 [[TMP2]], i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %arrayidx18 = getelementptr inbounds double, double* %C, i64 %4
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx = getelementptr inbounds double, double* %A, i64 %6
