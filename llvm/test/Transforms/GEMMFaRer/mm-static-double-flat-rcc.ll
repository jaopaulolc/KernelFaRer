...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64.i64(<128 x double> [[TMP6]], double* align 8 [[C:%.*]], i64 [[TMP2]], i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %5 = mul nsw i64 %indvars.iv50, %1
  %6 = add nsw i64 %5, %indvars.iv56
  %arrayidx18 = getelementptr inbounds double, double* %C, i64 %6
  store double %add14, double* %arrayidx18, align 8
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %exitcond55.not = icmp eq i64 %indvars.iv.next51, 8
