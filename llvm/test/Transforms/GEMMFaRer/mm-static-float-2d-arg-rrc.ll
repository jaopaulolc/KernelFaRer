...
define void @_Z11fixedSizeMMPA64_KfPA8_S_PA16_f([64 x float]* %A, [8 x float]* %B, [16 x float]* %C) {
; CHECK-LABEL: @_Z11fixedSizeMMPA64_KfPA8_S_PA16_f(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP7]], float* align 4 [[TMP2]], i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [64 x float], [64 x float]* %A, i64 %indvars.iv48, i64 %indvars.iv
