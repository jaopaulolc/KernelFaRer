...
define void @_Z11fixedSizeMMPA64_KfPA8_S_PA8_f([64 x float]* %A, [8 x float]* %B, [8 x float]* %C) {
; CHECK-LABEL: @_Z11fixedSizeMMPA64_KfPA8_S_PA8_f(
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP8]], float* align 4 [[TMP2]], i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
