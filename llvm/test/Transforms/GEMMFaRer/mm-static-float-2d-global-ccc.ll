...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP2]], float* align 4 getelementptr inbounds ([8 x [16 x float]], [8 x [16 x float]]* @C, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx18 = getelementptr inbounds [8 x [16 x float]], [8 x [16 x float]]* @C, i64 0, i64 %indvars.iv45, i64 %indvars.iv48
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx10 = getelementptr inbounds [64 x [16 x float]], [64 x [16 x float]]* @A, i64 0, i64 %indvars.iv, i64 %indvars.iv48
