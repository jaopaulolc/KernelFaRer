...
define void @_Z11fixedSizeMMPKfiS0_iPfi(float* %A, i32 %lda, float* %B, i32 %ldb, float* %C, i32 %ldc) {
...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32.i64(<128 x float> [[TMP7]], float* align 4 [[C:%.*]], i64 [[TMP2]], i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
...
for.cond.cleanup7:                                ; preds = %for.body8
  %4 = add nsw i64 %indvars.iv52, %3
  %arrayidx18 = getelementptr inbounds float, float* %C, i64 %4
  store float %add14, float* %arrayidx18, align 4
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx12 = getelementptr inbounds float, float* %B, i64 %9
